...
function getTagIcon(tagName: string) {
  const saved = localStorage.getItem(`tag-icon-${tagName}`);
  return saved || '1F1F7.png'; // 默认图标
}
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                {filteredBoards.map((board) => (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: '6px',
                      border: board.isActive 
                        ? (isDark ? '1px solid #4F46E5' : '1px solid #3B82F6')
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        minWidth: 0,
                                                 ...
                                                 {/* 图标 */}
                         <img
                           src={getIconPath(board.icon || 'default.png')}
                           alt=""
                           style={{
                             width: '20px',
                             height: '20px',
                        ...
                        <div style={{
                          ...
                          <div style={{
                            ...
                            gap: 8,
                                                         ...
                                                         <span>{board.cardCount || 0} 卡片</span>
                             <span>0 连线</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div style={{
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            handleToggleDropdown(e, board.id);
                          }}
                          style={{
                            padding: '4px',
                            border: 'none',
                    ...
                    {dropdownBoard === board.id && (
                      <div style={{
                        ...
                        >
                          <span>{board.shareId ? '🔗' : '📤'}</span>
                          {board.shareId ? '查看分享' : '分享'}
                        </button>
                ...
                {/* 搜索无结果提示 */}
                {boardSearchQuery && filteredBoards.length === 0 && (
                  <div style={{
                    padding: '20px',
                    textAlign: 'center',
                    color: isDark ? '#9CA3AF' : '#6B7280',
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ marginTop: '20px' }}>
                  <p style={{ color: isDark ? '#10B981' : '#059669' }}>
                    ✅ 阿里云存储配置并正常运行
                  </p>
                </div>
              </div>
